...
def test_book_places_with_enough_place_competition(client):
    """Test to reserve a number of places compatible with the number of places available for the competition."""
    server.clubs = [{
        "name": "Test club",
        "points": "4",
...
def test_book_places_without_enough_place_competition(client):
    """Test of reservation of a number of places incompatible with the number of places available for the competition."""
